...
Na het uitvoeren van de tutorial met seurat wordt nu gekeken naar de effecten van filtering van dataset E8.5 (GEO number GSE176588). Deze data is verkregen met VASA sequencing.
...
```{r Violin plot filter opties, echo=FALSE, fig.align='right', fig.cap="Verschillende filterings opties (strikt, mild en geen filter)", fig.height=9, fig.width=7}
...
We zien nu het effect van de filtering op de data. De bovenste rij is het strikte filter en we zien daar een duidelijk lijn welke cellen wel of niet wordt meegenomen. Bij de tweede rij (het milde filter) is deze lijn een stuk minder strak voor nFeature en nCount. Voor de laatste rij is geen filter gebruikt en bevat dus alle cellen. 
...
Stap 10. Van de 3 verschillende filter opties worden UMAPs gemaakt, om het verschil te laten zien. 
...
```{r UMAP plotten, echo=FALSE, fig.align='center', fig.cap="UMAP filter opties dataset E8.5", fig.height=7, fig.width=7}
print(umap_strict)
print(umap_mild)
print(umap_nofilter)
```
