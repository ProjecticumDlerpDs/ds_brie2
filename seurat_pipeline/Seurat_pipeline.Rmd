...
```{r echo=FALSE, fig.align='center', fig.width=10, fig.height=5, fig.cap="Dataset E8.5 in Violin Plots"}
...
## Nog conclusie trekken over kwaliteit
...
Stap 8.2 Top 10 genen van cluster 5 en 9 selecteren. 
...
Stap 8.3: Top 10 genen van custer 5 en 9 plotten

```{r echo=FALSE, fig.align='center', fig.width=10, fig.height=5, fig.cap="Top 10 genen cluster 5 en 9"}
...
### Deelconclusie: 
Op basis van deze resultaten zijn cluster 



## Conclusie 
Het data set is van goede kwaliteit
De juiste hoeveelheid PC zijn geselecteerd
Op basis hiervan konde clusters geselcteerd worden voor verdere analyse in BRIE2
